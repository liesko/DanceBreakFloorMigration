...
namespace DanceBreakFloorMigration.DB_objects
{
    public class Tbl_online_scoring : BaseClass, IMigration
    {
        public void Remigration(MySQL_DB pMysql, PostgreSQL_DB pPostgres)
        {
            ...
            {
                pPostgres.Insert("insert into tbl_online_scoring(id, awardid, tour_dates_id, studios_id, data_json, compgroup, total_score, dropped_score, routines_id) " +
                                 "values('"+dataReader["id"]+ "','" + dataReader["awardid"] + "','" + dataReader["tourdateid"] + "','" + dataReader["studioid"] + "',null," +
