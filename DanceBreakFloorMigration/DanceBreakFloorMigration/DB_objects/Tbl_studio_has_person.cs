    ...
    public class Tbl_studio_has_person:IMigration
    {
        public void Remigration(MySQL_DB pMysql, PostgreSQL_DB pPostgres)
        {
            pMysql.Message = "studios_has_person - extraction - START";
                pPostgres.Insert("insert into studios_has_person(studios_id, person_id) select c.studios_id, a.person_id from tbl_person a join tbl_user b using (person_id) " +
