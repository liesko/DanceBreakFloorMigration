DROP TABLE IF EXISTS "tbl_level" CASCADE;
...
CREATE TABLE "tbl_workshop_room_plan" (
	"workshop_room_plan_id" int4 NOT NULL,
	"room_bold" int4 DEFAULT 0,
	"room_highlight" int4 DEFAULT 0,
	"value" varchar,
	"room_name" varchar,
...
COMMENT ON COLUMN "tbl_date_routines_score"."post_fix_id" IS 'score1
score2...';
...
CREATE TABLE "tbl_tour_dates" (
	...
	"start_date" varchar,
	"end_date" varchar,
	"cutoff_start_date" varchar,
	"cutoff_end_date" varchar,
	"room_rate" varchar,
	"notes" text,
	...
	"weather_link" text,
	"hotel_alt" text,
	"custom_routine_durations" text,
	"default_category_order" text,
	"routine_dist" int4,
	"roomreservations" text,
	"webcast_this_city" int4 DEFAULT 0,
	"hotel_notes" text,
	"online_balance_payments_enabled" int4 DEFAULT 0,
	"event_date_status" varchar DEFAULT 'Available',
